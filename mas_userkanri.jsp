...
<html>
  ...
  <body>
    ...
    <form>
      ...
      <input placeholder="新規ユーザーネーム" type="text" required/>
      <input placeholder="現在のパスワード" type="password" required/>
      <input placeholder="新規パスワード" type="password" required/>
      <div class="error-message">※ 入力必須です</div>
      <button class="btn"><a href="settei_ok.jsp">変更</a></button>
    </form>

	<form method="post" action="/prototype/delete.jsp">
		<input type = "hidden" value = "<%= list.get(0).get("user_id") %>">
