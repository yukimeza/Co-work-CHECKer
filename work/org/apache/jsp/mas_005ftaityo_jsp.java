...
public final class mas_005ftaityo_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("\r\n");
		...
		try{		//ロードに失敗したときのための例外処理
					...
					//SQL文の発行（選択クエリ）
					SQL.append("select * from kintai_tbl ");
					...
					while(rs.next()){
						//DBのデータをHashMapへ格納する
								...
								map.put("taion",rs.getString("taion"));
								map.put("kibun",rs.getString("kibun"));
 ...
 if(ERMSG != null){ 
      ...
      out.print( list.get(i).get("part_name") );
      out.write("</span>\r\n");
      out.write("\t\t<br>\r\n");
      out.write("\t\t<span>体温  ");
      out.print( list.get(i).get("taion") );
      out.write("</span>\r\n");
      out.write("\t\t<br>\r\n");
      out.write("\t\t<span>気分  ");
      out.print( list.get(i).get("kibun") );
      out.write("</span>\r\n");
      out.write("\t</form>\r\n");
      out.write("\t\r\n");
      out.write("\t");
